...
/**
    ...
    public function Index(){
          //mostrar tela inicial mostra projetos
            ...
            ->select(DB::raw("projetos.id_projetos,empresas.nome_fantasia,empresas.telefone_fixo,users.name,responsavel_implantacao,data_inicio,data_fim,data_negociada,status,id_cidade,concat(nome_municipio,' / ',uf) as cidade"))
            ->orderBy('data_inicio')
