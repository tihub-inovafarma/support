    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Versões Inovafarma',
					'icon' => 'fa fa-heartbeat nav-icon',
                    'url'  => 'download/versoes',
                ],
                [
                    'text' => 'Aplicativos',
					'icon' => 'fas fa-database nav-icon',
                    'url'  => 'download/aplicativos',
                ],
            ],
        ...
        [
            'text' => 'Links',
            'url'  => 'link',
            'icon' => 'nav-icon fa fa-link nav-icon',
        ],
