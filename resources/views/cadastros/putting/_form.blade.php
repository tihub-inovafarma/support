<div class="card-body">
  <div class="row">
    <div class="form-group col-md-3 {{ $errors->has('tEmpresa') ? ' has-error' : '' }}">
      ...
      {!! Form::select('tEmpresa', $empresasLista, isset($empresaDados->codigo_ibge) ? $empresaDados->codigo_ibge : null, ['class' => 'company-show-search form-control','placeholder' => 'Selecione a Empresa','onkeyup' => 'upper(this)']) !!}
    ...
    <div class="form-group col-md-3 {{ $errors->has('tRazaoSocial') ? ' has-error' : '' }}">
      ...
      {!! Form::text('responsavel_implantacao',isset($empresaDados->razao_social) ? $empresaDados->razao_social : null,['class' => 'form-control','placeholder' => '','onkeyup' => 'upper(this)']) !!}
    ...
    <div class="form-group col-md-3">
      ...
      {!! Form::select('tSistema', array('1' => 'SIM','2' => 'NAO'), isset($empresaDados->sistema) ? $empresaDados->sistema : 1, ['class' => 'form-control']) !!}
      <small class="text-danger">{{ $errors->first('tSistema') }}</small>
    </div>
  </div>
  <div class="" role="tabpanel" data-example-id="togglable-tabs">
    <h3 class="card-title">Acordos Comerciais</h3>
